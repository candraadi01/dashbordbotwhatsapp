...
const BOT_PANEL_QRIS = path.join("D:", "BOT WHSATAPP SUPABASE", "BOT CANDRA", "BOT PANEL", "database", "img", "payment", "payment.jpg");
const BOT_PANEL_BACKUP_QRIS = path.join("D:", "BOT WHSATAPP SUPABASE", "BOT CANDRA", "BOT PANEL BACKUP", "database", "img", "payment", "payment.jpg");
